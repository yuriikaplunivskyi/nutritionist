...
const fakeServiceData = [
    {
        ...
        passing: [
            {
                stage: `Aналіз вашої анкети та щоденнику харчування (заповненого протягом 5 днів)
                вступний дзвінок-знайомство з детальним обговоренням ваших запитів, побажань, скарг, ціле`,
                id: 1
            },
            {
                ...
                stage: `Повторний дзвінок з обговоренням, узгодженням та фіналізацією рекомендацій
