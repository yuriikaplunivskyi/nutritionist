...
const items = [
    ...
    {
        id: 1,
        icon: "%PUBLIC_URL%/icon/about/profile.svg",
        img: "%PUBLIC_URL%/about/about-1.JPG",
        desc: "Ви заповнюєте анкету та ведете щоденник харчування протягом 3-5 днів."

    },
    {
        id: 2,
        icon: "%PUBLIC_URL%/icon/about/consultation.svg",
        img: "%PUBLIC_URL%/about/about-2.JPG",
    ...
    {
        id: 3,
        icon: "%PUBLIC_URL%/icon/about/advice.svg",
        img: "%PUBLIC_URL%/about/about-3.JPG",
    ...
    {
        id: 4,
        icon: "%PUBLIC_URL%/icon/about/no-bads.svg",
        img: "%PUBLIC_URL%/about/about-4.JPG",
    ...
    {
        id: 5,
        icon: "%PUBLIC_URL%/icon/about/looking.svg",
        img: "%PUBLIC_URL%/about/about-5.JPG",
    ...
    {
        id: 6,
        icon: "%PUBLIC_URL%/icon/about/growth.svg",
        img: "%PUBLIC_URL%/about/about-6.JPG",
