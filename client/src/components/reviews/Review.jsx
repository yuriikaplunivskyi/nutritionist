...
const items = [
    ...
    },
    {
        ...
        desc: "Моя мета полягає у внесенні позитивних змін у життя моїх клієнтів через тренування та збалансоване харчування. Я прагну показати, що збалансоване харчування та тренування не є обмеженнями, а скрізь та завжди відкривають великі можливості для досягнення мети та гармонії в житті."
